...
public:
	...
	void pop(T& value) {
		...
		// Block when the queue is empty. Notice the !que.empty() predicate, it's to avoid spurious and lost wakeups, and also we only want to wait when the queue is not empty

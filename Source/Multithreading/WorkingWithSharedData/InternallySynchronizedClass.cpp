...
//
//		// Start of critical section
//		// Needs to be a critical section otherwise it might run while a thread is pushing to the vector (which might cause resizing and reading unknown data locations)
//		for (auto i : vec) {
//			std::cout << i << ", ";
//		}
//
